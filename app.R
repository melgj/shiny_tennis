...
atpHistory <- read_csv("atp_shiny_timeline.csv", col_names = T)
atpRatings <- read_csv("atp_SR_ratings.csv", col_names = T)
matches <- read_csv("atp_shiny_matches.csv", col_names = TRUE)
